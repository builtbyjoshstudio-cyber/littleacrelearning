...
- **`content/posts.ts`** — blog posts (**9 live posts** as of 2026-07-22). Originals with fictional authors preserved (unpublished) in **`content/drafts/posts.ts`** — see §7.
